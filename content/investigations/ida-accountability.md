---
title: "New York IDA Accountability"
date: 2026-03-16
...
<strong>Part of the <a href="/ida/">national IDA subsidy accountability project</a>.</strong> New York is the flagship analysis with the deepest county-level data — 104 IDAs, 2,753 county scorecards.
</div>
...
Cross-referencing IDA project data (34,348 projects) from the NYS Authorities Budget Office against 12.49 million campaign contribution records from the NYS Board of Elections, this analysis identified systematic financial relationships between the companies receiving tax breaks and the politicians who appoint the boards granting them.

### The numbers

| Metric | Value |
|--------|-------|
| Total IDA projects analyzed | 34,348 |
| Total property tax exemptions | $12.19 billion |
| IDA beneficiaries matched to campaign donations | 1,444 (exact + LLC matching) |
| Total donations from IDA beneficiaries | $27.63 million (exact + LLC matching) |
...
- [Onondaga County](/ida/counties/ny/onondaga/) — Pyramid/Destiny USA: $201M in subsidies at a 9,094x exemption-to-donation ratio
- [Tioga County](/ida/counties/ny/tioga/) — A racetrack, a convicted senator, and 12 years of dual-hatting

*Data dashboards for all counties are live. Longer narrative briefs for each county are in progress.*

## Data downloads

- [County Scorecards](/data/ida_county_scorecards.csv) — All 104 IDAs ranked
- [Tax Shift by County](/data/tax_shift_by_county.csv) — Per-household burden
- [School District Impact](/data/ny_district_impact.csv) — 478 districts

## Methodology

Headline figures use exact name matching and LLC-parent matching only. A broader word-overlap analysis (75% threshold) identified 1,618 unique beneficiaries and $41.97 million in total donations across all match tiers, but these figures are excluded from primary claims due to higher false-positive risk. All findings document correlations between donations and exemptions; this analysis does not establish that donations caused approvals. See [full methodology](/methodology/) for details.
