---
title: "NYS Power: Who Pays for Regulatory Capture"
description: "New York electricity rates are 49.7% above the national average. Clean energy mandates account for just 4.7% of rate increases. We traced where the other 95.3% went — and who lobbied to get it."
date: 2026-03-17
status: "complete"
tags: ["new-york", "utilities", "regulatory-capture", "campaign-finance", "lobbying"]
layout: "deep-dive"
deep_dive_slug: "nys_power"
category: "money"
hub_stat: "NY electricity rates 49.7% above national average"
sources:
  - "NYS Board of Elections campaign finance"
  - "FEC federal contributions"
  - "COELIG/JCOPE lobbying disclosures"
  - "EIA electricity pricing data"
  - "FERC financial filings"
  - "PSC rate case records"
  - "ProPublica 990 nonprofit filings"
---

New York residents pay **49.7% more** for electricity than the national average — 25.19¢ per kilowatt-hour versus 16.83¢ (EIA 2024 annual average, all-in residential retail rate). The standard explanation is the state's aggressive clean energy mandates. The public record shows a different pattern.
...
{{< source-note db="NYS Board of Elections, FERC, EIA, PSC" date="2026-03-17" >}}
